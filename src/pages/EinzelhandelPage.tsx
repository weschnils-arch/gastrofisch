        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6">
              ...
              <div className="p-4 glass-card rounded-lg border-adria/10"><h3 className="font-playfair text-lg font-semibold text-adria mb-2">Bistro</h3><p className="font-lato text-sm text-graphite/70">Genießen Sie unsere Tagesfänge direkt vor Ort.</p></div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="glass-card bg-gray-100/30 backdrop-blur-sm rounded-xl overflow-hidden h-[300px] flex items-center justify-center border-white/40">
